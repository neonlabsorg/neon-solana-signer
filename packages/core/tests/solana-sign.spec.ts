...
beforeAll(async () => {
  ...
  const keypair = Keypair.fromSecretKey(bs58.decode(`2PDDoDzNNdE1dWfyZHmoquJd7eJ4LaHuJZP1yeWqAsdmG78BntMusguab5A5egGxA3eXnob5HSVBfGeXSq4NKqEQ`));
